    ...
    <div className="min-h-screen bg-[var(--landing-bg)] text-[var(--landing-body)]">
      ...
      <main className="container pt-36 pb-20">
        <section className="landing-surface max-w-4xl rounded-3xl p-6 sm:p-8 md:p-10">
          ...
          <div className="mt-7 space-y-6 text-sm leading-relaxed text-[var(--landing-body)]">
            <section>
              <h5 className="font-playfair text-2xl font-semibold text-[var(--landing-heading)]">Our Mission</h5>
              <p className="mt-2">
            ...
            <section>
              <h5 className="font-playfair text-2xl font-semibold text-[var(--landing-heading)]">What We Build</h5>
            ...
            <section>
              <h5 className="font-playfair text-2xl font-semibold text-[var(--landing-heading)]">How We Work</h5>
              <p className="mt-2">
          ...
          <p className="mt-7 text-sm text-[var(--landing-secondary)]">

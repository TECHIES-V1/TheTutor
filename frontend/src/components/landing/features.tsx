...
export function Features() {
  return (
    <section id="features" className="relative overflow-hidden border-y border-[#c9a227] bg-[#fafaf8] py-20 md:py-28">
      <div className="container relative z-10">
        ...
        >
          ...
          <h2 className="mt-3 text-[35px] font-bold text-[#1a1a1a] md:text-5xl text-balance leading-tight">A Tutor Experience Built For & Around You</h2>
          <p className="mt-4 text-base text-[#333333] md:text-lg text-[14px]">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="p-6 text-center md:text-left">
                <h3 className="font-playfair md:text-2xl font-bold text-[#1a1a1a] text-[20px]">{feature.title}</h3>
                <p className="mt-3 text-base leading-relaxed text-[#333333] md:text-[16px] text-[14px]">{feature.description}</p>
              </div>
            </motion.article>
          ))}
        </div>

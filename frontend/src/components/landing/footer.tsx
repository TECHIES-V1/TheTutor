...
export function Footer() {
  ...
  return (
    <footer id="footer" className="border-t border-[#c9a227] bg-[#f0e9dd]">
      ...
      <div className="container flex flex-col items-center gap-3 py-8 text-center md:hidden">
        <div className="flex items-center gap-2.5">
          ...
          <p className="font-playfair text-lg font-bold text-[#4a3728]">TheTutor</p>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-xs text-[#7a6644]">
        ...
        <p className="text-xs text-[#7a6644]">&copy; {currentYear} TheTutor. All rights reserved.</p>
      </div>
      ...
      <div className="container hidden py-14 md:block">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-playfair text-xl font-bold text-[#4a3728]">
                  TheTutor
                </p>
                <p className="text-[11px] uppercase tracking-[0.14em] text-[#7a6644]">
                  AI-Powered Learning Coach
                </p>
              </div>
            </div>
            <p className="mt-5 max-w-md text-sm leading-relaxed text-[#7a6644]">
              Personalized tutoring for learners who want clear structure, practical feedback, and consistent progress.
            </p>
          </div>

          <div>
            <h4 className="font-playfair text-lg font-bold text-[#4a3728]">
              Product
            </h4>
            <ul className="mt-4 space-y-2 text-sm text-[#7a6644]">
        ...
        <div className="mt-10 border-t border-[#c9a227] pt-6 text-sm text-[#7a6644]">

...
const triggerClass =
    "neo-inset h-10 w-full rounded-xl border-0 bg-transparent px-3 text-sm text-foreground cursor-pointer focus:ring-1 focus:ring-primary/50 transition-all";
    ...
    return (
        <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 lg:flex lg:w-auto lg:flex-nowrap lg:items-center lg:gap-3">
            ...
            <Select value={category} onValueChange={onCategoryChange}>
                ...
                <SelectContent className="border-primary/30 bg-white text-foreground">
                    {CATEGORIES.map((c) => (
                        <SelectItem
                            key={c}
                            value={c}
